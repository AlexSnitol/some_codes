...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label_program_name->Text = L"Äîïîëíèòåëüíûå óòèëèòû äëÿ ðàáîòû ñ Frontol 5";
			// 
			// panel1
			// 
			...
			this->journal_clear->Text = L"Î÷èñòèòü æóðíàë";
			...
			this->show_hide_journal->Text = L"Ñêðûòü æóðíàë";
			...
			this->tabPage1->Text = L"Èñïðàâëåíèå îøèáîê";
			...
			this->fix_errors_uncheck_all->Text = L"Óáðàòü âñå";
			...
			this->fix_errors_check_all->Text = L"Âûáðàòü âñå";
			...
			this->fix_errors_copy->Text = L"Ñîçäàâàòü êîïèè";
			...
			this->fix_errors_run->Text = L"Çàïóñòèòü";
			...
			this->fix_errors_appy->Text = L"Ïðèìåíèòü";
			...
			this->fix_errors_label_filename->Text = L"Íàçâàíèå ôàéëà:";
			// 
			// fix_errors_delete
			// 
			...
			this->fix_errors_delete->Text = L"Óäàëèòü";
			...
			this->fix_errors_add->Text = L"Äîáàâèòü";
			...
			this->fix_errors_label_files->Text = L"Ñïèñîê ïàïîê:";
			// 
			// tabPage2
			// 
			...
			this->tabPage2->Text = L"Ðàáîòà ñ ÁÄ";
			...
			this->groupBox2->Text = L"Îáíîâëåíèå öåí";
			// 
			// button25
			// 
			...
			this->groupBox1->Text = L"Äîáàâëåíèå êëèåíòîâ";
			// 
			// button13
			// 
			...
			this->db_dataGridView_paths->Size = System::Drawing::Size(415, 313);
			...
			this->description->HeaderText = L"Îïèñàíèå";
			...
			this->path->HeaderText = L"Ïîëíûé ïóòü";
			this->path->Name = L"path";
			// 
			// username
			// 
			this->username->AutoSizeMode = System::Windows::Forms::DataGridViewAutoSizeColumnMode::AllCells;
			this->username->HeaderText = L"Ïîëüçîâàòåëü";
			...
			this->password->HeaderText = L"Ïàðîëü";
			...
			this->db_text_path->Size = System::Drawing::Size(116, 20);
			...
			this->label4->Text = L"Ïîëíûé ïóòü äî ôàéëà:";
			// 
			// db_delete
			// 
			...
			this->db_uncheck_all->Location = System::Drawing::Point(326, 6);
			...
			this->db_uncheck_all->Text = L"Óáðàòü âñå";
			...
			this->label3->Text = L"Ñïèñîê ïóòåé äî ÁÄ:";
			// 
			...
			this->db_client_send_request->Location = System::Drawing::Point(276, 994);
			...
			this->db_client_send_request->Text = L"Îòïðàâèòü çàïðîñ";
			...
			this->db_card_send_request->Location = System::Drawing::Point(276, 689);
			...
			this->db_card_send_request->Text = L"Îòïðàâèòü çàïðîñ";
			...
			this->db_client_remove->Location = System::Drawing::Point(373, 726);
			...
			this->db_card_delete->Location = System::Drawing::Point(373, 422);
			...
			this->db_client_add->Location = System::Drawing::Point(342, 726);
			...
			this->db_card_add->Location = System::Drawing::Point(342, 422);
			...
			this->db_dataGridView_client->Size = System::Drawing::Size(418, 231);
			...
			this->client_old->HeaderText = L"Ñòàðûé";
			...
			this->client_new->HeaderText = L"Íîâûé";
			...
			this->label2->Text = L"Çàìåíà òàáåëüíîãî íîìåðà:";
			// 
			...
			this->card_new->HeaderText = L"Íîâûé";
			...
			this->label1->Text = L"Çàìåíà ïðîïóñêà:";
			// 
			// splitContainer1
			// 
			...
			this->Consol->Text = L"Äîáðî ïîæàëîâàòü!  Çäåñü îòîáðàæàåòñÿ èñòîðèÿ îïåðàöèé.";
			// 
			// openFileDialogGDB
			// 
			this->openFileDialogGDB->FileName = L"openFileDialogGDB";
			this->openFileDialogGDB->Filter = L"Firebird áàçà äàííûõ (*.GDB)|*GDB|Âñå ôàéëû|*.*";
			this->openFileDialogGDB->RestoreDirectory = true;
			this->openFileDialogGDB->Title = L"Âûáåðèòå áàçó äàííûõ Firebird";
			// 
			// Index
			// 
			...
			this->Text = L"Äîïîëíèòåëüíûå óòèëèòû Frontol 5";
...
#pragma endregion
	...
	private: System::Void Index_Load(System::Object^  sender, System::EventArgs^  e) {
				...
				if (setting_head == "general")
				{
					...
					if (setting_type == "journal_state")
					{
						if (CutText(setting_value, 0, setting_value.size() - 1) == "show")
						{
							...
							show_hide_journal->Text = "Ñêðûòü æóðíàë";
							journal_clear->Visible = true;
						}
						else
						{
							splitContainer1->Panel2Collapsed = true;
							show_hide_journal->Text = "Ïîêàçàòü æóðíàë";
		...
		{
			MessageBox::Show("Ôàéë íàñòðîåê íå íàéäåí èëè ïîâðåæä¸í.", "Îøèáêà ÷òåíèÿ ôàéëà", MessageBoxButtons::RetryCancel, MessageBoxIcon::Error);
		}
		filein.close();
	...
	if (filein.is_open())
	{
		while (getline(filein, setting_current_row))
		{
			...
			if (setting_head == "general")
			{
				...
				if (setting_type == "journal_state")
				{
					if (show_hide_journal->Text == "Ñêðûòü æóðíàë")
					{
...
private: System::Void fix_errors_appy_Click(System::Object^ sender, System::EventArgs^ e) {
	...
	//MessageBox::Show(msclr::interop::marshal_as<String^>(settings[k]), "Ïðîâåðêà ïåðåìåííîé", MessageBoxButtons::OK, MessageBoxIcon::Information);
}
...
private: System::Void fix_errors_run_Click(System::Object^ sender, System::EventArgs^ e) {
	Consol->AppendText("\r\n" + "Çàïóùåíà óòèëèòà î÷èñòêè îøèáîê.");
	ProgressBarStatus(0);
		...
		if (fix_errors_files->GetItemChecked(i_file) == true)
		{
			...
			if (filein.is_open())
			{
				...
				if (fix_errors_copy->Checked == true)
				{
					...
					//Äîáàâëåíèå ê èìåíè êîïèè ôàéëà òåêóùóþ äàòó è âðåìÿ
					time_t t = time(NULL);
					...
					//Ïðîâåðêà íà ñóùåñòâîâàíèå ôàéëà ñ òàêèì æå íàçâàíèåì
					int file_check_k = 1;
				...
				filein.close();
				filein.open(FileDir + msclr::interop::marshal_as<std::string>(fix_errors_filename->Text));
				Consol->AppendText("\r\n" + "Îáðàáàòûâàåòñÿ ôàéë " + fix_errors_files->GetItemText(fix_errors_files->Items[i_file]) + "\\" + fix_errors_filename->Text);
			...
			{
				Consol->AppendText("\r\n" + "Ôàéë " + fix_errors_files->GetItemText(fix_errors_files->Items[i_file]) + "\\" + fix_errors_filename->Text + " íå íàéäåí.");
			}
	...
	Consol->AppendText("\r\n" + "Óñïåøíî îáðàáîòàííî " + k_succesful + " ôàéëîâ èç " + fix_errors_files->CheckedItems->Count + ".");
	Consol->AppendText("\r\n" + "Âñåãî èñïðàâëåííî " + k_errors_sum + " îøèáîê.");
	k_errors_sum = 0;
...
private: System::Void db_card_send_request_Click(System::Object^ sender, System::EventArgs^ e) {
	Consol->AppendText("\r\n" + "Ïðîèñõîäèò âûïîëíåíèå îïåðàöèé ïî îáðàáîòêå çàïðîñà íà ðåäàêòèðîâàíèå ïðîïóñêà (-îâ) êëèåíòà (-îâ).");
	wchar_t CurDirExe[MAX_PATH];
	GetModuleFileName(GetModuleHandle(0), CurDirExe, MAX_PATH);
	String^ CurDirExeSTR1 = msclr::interop::marshal_as<String^>(CurDirExe);
	std::string CurDirExeSTR2 = msclr::interop::marshal_as<std::string>(CurDirExeSTR1);
	...
	catch (...)
	{
		...
		MessageBox::Show("Îøèáêà çàïóñêà BAT ôàéëà\r\n\r\nÝòî ìîæåò âîçíèêíóòü ïî îäíîé èç ñëåäþùèõ ïðè÷èí:\r\n" +
			"\r\n" + " 1. Âû îòìåíèíè çàïóñê îò èìåíè àäìèíèñòðàòîðà." +
			"\r\n" + " 2. Ôàéë ïî ïóòè " + msclr::interop::marshal_as<String^>(CurDir) + "\send query.bat.lnk" + " îòñóòñòâóåò." +
			"\r\n" + " 3. Ôàéë ïîâðåæä¸í."
			, "Îøèáêà çàïóñêà BAT ôàéëà", MessageBoxButtons::OK, MessageBoxIcon::Error);
	}
	Consol->AppendText("\r\n" + "Îïåðàöèè äëÿ îáðàáîòêè çàïðîñà íà ðåäàêòèðîâàíèå ïðîïóñêà (-îâ) êëèåíòà (-îâ) çàâåðøåíû.");
}
...
private: System::Void db_client_send_request_Click(System::Object^ sender, System::EventArgs^ e) {
	Consol->AppendText("\r\n" + "Ïðîèñõîäèò âûïîëíåíèå îïåðàöèé ïî îáðàáîòêå çàïðîñà íà ðåäàêòèðîâàíèå òàáåëüíîãî (-ûõ) íîìåðà (-îâ).");
	wchar_t CurDirExe[MAX_PATH];
	GetModuleFileName(GetModuleHandle(0), CurDirExe, MAX_PATH);
	String^ CurDirExeSTR1 = msclr::interop::marshal_as<String^>(CurDirExe);
	std::string CurDirExeSTR2 = msclr::interop::marshal_as<std::string>(CurDirExeSTR1);
	...
	Consol->AppendText("\r\n" + "Îïåðàöèè äëÿ îáðàáîòêè çàïðîñà íà ðåäàêòèðîâàíèå òàáåëüíîãî (-ûõ) íîìåðà (-îâ) çàâåðøåíû.");
}
...
private: System::Void db_card_send_request_client_Click(System::Object^ sender, System::EventArgs^ e) {
	Consol->AppendText("\r\n" + "Ïðîèñõîäèò âûïîëíåíèå îïåðàöèé ïî îáðàáîòêå çàïðîñà íà ïîëó÷åíèå ñâåäåíèé î êëèåíòå (-àõ).");
	wchar_t CurDirExe[MAX_PATH];
	GetModuleFileName(GetModuleHandle(0), CurDirExe, MAX_PATH);
	String^ CurDirExeSTR1 = msclr::interop::marshal_as<String^>(CurDirExe);
	std::string CurDirExeSTR2 = msclr::interop::marshal_as<std::string>(CurDirExeSTR1);
	...
	//Consol->AppendText("\r\n" + "Îïåðàöèè äëÿ îáðàáîòêè çàïðîñà íà ïîëó÷åíèå ñâåäåíèé î êëèåíòå (-àõ) çàâåðøåíû.");
}
private: System::Void button1_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in all stantion.bat");
}
private: System::Void button11_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 1 - Äðóæáà.bat");
}
private: System::Void button10_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 2 - Ñåâåðÿíêà.bat");
}
private: System::Void button2_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 3 - á. Ñåâåðÿíêà.bat");
}
private: System::Void button3_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 4 - Ìàãàçèí.bat");
}
private: System::Void button4_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 5 - ÌÏ1.bat");
}
private: System::Void button5_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 6 - ÊÁÏ.bat");
}
private: System::Void button6_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 7 - Ñóäàðóøêà.bat");
}
private: System::Void button7_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 8 - ¨ëî÷êà.bat");
}
private: System::Void button8_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 9 - ÐÌÏ.bat");
}
private: System::Void button9_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 10 - ÒÝÖ.bat");
}
private: System::Void button13_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ äîáàâëåíèÿ è áëîêèðîâàíèÿ êëèåíòîâ\\copy in 11 - ÁÄÌ7.bat");
}
private: System::Void button24_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in all stantion.bat");
}
private: System::Void button14_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 1 - Äðóæáà.bat");
}
private: System::Void button15_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 2 - Ñåâåðÿíêà.bat");
}
private: System::Void button23_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 3 - á. Ñåâåðÿíêà.bat");
}
private: System::Void button22_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 4 - Ìàãàçèí.bat");
}
private: System::Void button21_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 5 - ÌÏ1.bat");
}
private: System::Void button20_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 6 - ÊÁÏ.bat");
}
private: System::Void button19_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 7 - Ñóäàðóøêà.bat");
}
private: System::Void button18_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 8 - ¨ëî÷êà.bat");
}
private: System::Void button17_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 9 - ÐÌÏ.bat");
}
private: System::Void button16_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 10 - ÒÝÖ.bat");
}
private: System::Void button12_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\copy in 11 - ÁÄÌ7.bat");
}
private: System::Void button25_Click(System::Object^ sender, System::EventArgs^ e) {
	System::Diagnostics::Process::Start("F:\\input äëÿ îáíîâëåíèÿ öåí è òîâàðîâ\\cut from server.bat");
}
};
}
